...
function ajaxkota(id){
  var url="http://januridp.dev/peninggaran/daerah/getKab/"+id+"/"+Math.random();
...
function ajaxkec(id){
  var url="http://januridp.dev/peninggaran/daerah/getKec/"+id+"/"+Math.random();
...
function ajaxkel(id){
  var url="http://januridp.dev/peninggaran/daerah/getKel/"+id+"/"+Math.random();
